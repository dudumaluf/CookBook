...
import { telestyleV2NodeSchema } from "@/components/nodes/node-fal-telestyle-v2";
...
import { sam3NodeSchema } from "@/components/nodes/node-sam3";
...
export function registerAllNodes(): void {
  ...
  nodeRegistry.register(dwposeNodeSchema);
  nodeRegistry.register(telestyleV2NodeSchema);
  ...
  nodeRegistry.register(h3MaxVideoNodeSchema);
  ...
  nodeRegistry.register(audioToVideoNodeSchema);
  ...
  nodeRegistry.register(composerNodeSchema);
  nodeRegistry.register(textConcatNodeSchema);
  nodeRegistry.register(imageCropNodeSchema);
  nodeRegistry.register(resizeImageNodeSchema);
  nodeRegistry.register(resizeVideoNodeSchema);
